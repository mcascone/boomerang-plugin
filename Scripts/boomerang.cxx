...
array<string> inputParametersNames={"Record","Play","Once","Direction","Stack (Speed)","Thru Mute","Output Level"};
...
array<string> outputParametersNames={"Rec","Play","Once","Reverse","Stack"};
